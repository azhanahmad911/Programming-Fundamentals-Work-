   ...
   if(email != "vscodeproject@gmail.com" || password != 911){
         ...
         if(login=="Buyer" || login=="buyer"){
            ...
            // HOME AND GARDEN 
               ...
               if(howmanyitems == 0){
                  ...
                  cout<<endl<<"Item Name"<<"\t\t"<<"Brand"<<"\t"<<"Price"<<"\t"<<"Quantity"<<endl<<endl;
                  
                  for(int i=0; i<howmanyitems; i++){

                     cout<<itemname[i]<<"\t\t"<<itembrand[i]<<"\t"<<itemprice[i]<<"\t"<<itemquantity[i]<<endl;
         ...
         // SELLER INTERFACE 
            ...
            if(selleroption == 1){
               ...
               cout<<endl<<"Enter Number of Items: "<<endl;
               cin >> howmanyitems;

               for(int i=0; i<howmanyitems; i++){

                  cout<<endl<<i+1<<". "<<"Enter Item Name: "<<endl;
                  cin >> itemname[i];

                  cout<<endl<<"Enter Brand Name: "<<endl;
                  cin >> itembrand[i];

                  cout<<endl<<"Enter Unit Price: "<<endl;
                  cin >> itemprice[i];

                  cout<<endl<<"Enter Item In Stock: "<<endl;
                  cin >> itemquantity[i];
